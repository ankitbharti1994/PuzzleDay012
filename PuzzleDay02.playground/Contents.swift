...
import XCTest
    ...
    */
    func curruptionChecksum(_ input: [[Int]]) -> Int {
    ...
    func convertStringToArrayOfInt(_ inputString: String) -> [[Int]] {
...
// Testing
let result0 = curruptionChecksum([[1,4,5,6],[10,3,4,1],[3,5,6,2]])
XCTAssertTrue(result0 == 18, "result should be 18")

let result1 = curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8]])
XCTAssertTrue(result1 == 18, "result should be 18")


let result2 = curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8],[]])
XCTAssertTrue(result2 == 18, "result should be 18")

let result3 = curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8],[], [4,6,1,8]])
XCTAssertTrue(result3 == 25, "result should be 25")
...
let result = convertStringToArrayOfInt(inputString)
let finalResult = curruptionChecksum(result)

XCTAssertTrue(finalResult == 45158, "result should be 45158")
