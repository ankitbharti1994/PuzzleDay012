...
// Testing
let result0 = Utility.curruptionChecksum([[1,4,5,6],[10,3,4,1],[3,5,6,2]])
XCTAssertTrue(result0 == 18, "result should be 18")

let result1 = Utility.curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8]])
XCTAssertTrue(result1 == 18, "result should be 18")


let result2 = Utility.curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8],[]])
XCTAssertTrue(result2 == 18, "result should be 18")

let result3 = Utility.curruptionChecksum([[5,1,9,5],[7,5,3],[2,4,6,8],[], [4,6,1,8]])
...
let result = Utility.convertStringToArrayOfInt(inputString)
let finalResult = Utility.curruptionChecksum(result)
